...
### 6) 档位2：龙虾小队（多智能体）
- 新增 5 个专项角色（初始评分 100）：情报/代码/测试/运维/文档。
- 新增小队任务系统：派发任务、双评打分（你+队长）、积分更新。
- 低于 60 分触发预警并要求自省，支持提交改进反思。
- 控制台新增“龙虾小队”视图，实时展示角色状态、排行榜、任务大厅。
- 总览面板补充小队快照（均分、低分预警数）。
...
- `docs/refactor/step8-lobster-squad.md`
